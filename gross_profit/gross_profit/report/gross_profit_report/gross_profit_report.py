# # Copyright (c) 2013, Akeru Ebuka and contributors
...
from erpnext.stock.utils import get_incoming_rate,get_stock_value_on,get_stock_balance
...
class GrossProfitGenerator(object):
	...
	def process(self):
		...
		for row in self.si_list:
			...
			# print(f'\n\n\nProduct Bundles:{self.product_bundles}\n\n\n\n')
			# get buying amount
			if row.item_code in product_bundles:
				# print(f"\n\n\n\n\n\n PRODUCT BUNDLE ROW:{row}")
				...
				row.buying_amount = flt(self.get_product_bundle_rate(row,product_bundles[row.item_code]))
				print(f'\n\n\n\n PACK:{row.buying_amount}\n\n\n')
